...
function Detail(props) {
  ...
  console.log('this is listCart', listCart);
  ...
  console.log('this is idUser', idUser);
  // Listcomment
  ...
  console.log('this is new products', product);
  ...
  const addToCart = () => {
    ...
    console.log('this is id_user_cart', id_user_cart);
    const data = {
      idUser: id_user_cart,
    ...
    if (localStorage.getItem('id_user')) {
      ...
      const fetchPostAddToCart = async () => {
        // params here are cart to add to Cart Model
        const item = {
        ...
        const response = await CartAPI.postAddToCart(item);
        console.log(response);
        if (response.cart) {
        ...
        <div className="row mb-5">
          ...
          <div className="col-lg-6">
            ...
            {idUser !== '' ? (
              ...
              <>
                <h3>Please login to add this product to cart</h3>
              </>
            )}
          </div>
        </div>
